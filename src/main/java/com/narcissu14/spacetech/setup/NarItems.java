...
public class NarItems {
    public static @Nullable ItemStack UU = null;
    public static @Nullable ItemStack UU_MACHINE = null;
    public static @Nullable ItemStack ITEM_COPIER = null;
    public static @Nullable ItemStack ITEM_CREATOR = null;
    public static @Nullable ItemStack IRIDIUM = null;

    static {
        try {
            UU = new CustomItemStack(SkullUtil.getByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGYxNGYzMTc5Yjg2ZjY5YjNlZmE3NDcyZGFjYWViMjMzOWY2MjkwZDJkODE3MzYyNzkzMzQ4YWJkOThlMDIxIn19fQ=="), "&d元物质", new String[]{"", "§7这堆元物质被特殊的力场禁锢而得以保存", "§7据研究元物质是万物的最基本组成粒子", "§7珍贵的元物质有非常广泛的用途"});
            ...
            IRIDIUM = new CustomItemStack(SkullUtil.getByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGNmNWI4ZGViM2Q3YWZlMGY0ZmZhNjI3N2RlZjk3NjYxOWE2N2NjMTYzMTUzMTk4M2U4NTkwODI2ZWRlNjQ2MCJ9fX0="), "&d铱", new String[]{"", "&7一种稀有的贵重金属", "&7可以用于制作一些高级装备"});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
